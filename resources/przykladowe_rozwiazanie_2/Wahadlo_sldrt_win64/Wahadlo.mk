...
MODEL                := Wahadlo
MODULES              := Wahadlo_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Wahadlo.mk
...
#
MODELLIB                  := Wahadlolib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Wahadlo_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/LP_pon_0930/Wahadlo_sldrt_win64;E:/LP_pon_0930;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
