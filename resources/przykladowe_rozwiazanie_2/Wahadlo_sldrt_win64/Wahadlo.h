...
typedef struct {
  real_T ResetEncoders1;               /* '<Root>/Reset Encoders1' */
...
struct P_Wahadlo_T_ {
  ...
  real_T AlfaNormalization_pos;        /* Mask Parameter: AlfaNormalization_pos
                                        ...
                                        */
  real_T Ctrl_Value;                   /* Expression: 0
  ...
  real_T Reset_Value;                  /* Expression: 1
                                        ...
                                        */
  real_T Ctrl1_Value;                  /* Expression: -1
 ...
 *
 * '<Root>' : 'Wahadlo'
 * '<S1>'   : 'Wahadlo/Alfa Normalization'
 * '<S2>'   : 'Wahadlo/Cart-Pendulum System'
 * '<S3>'   : 'Wahadlo/Sensors'
 * '<S4>'   : 'Wahadlo/Slider Gain'
 */
