...
MODEL                := ts_pendulim
MODULES              := rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c ts_pendulim_data.c 
MAKEFILE             := ts_pendulim.mk
...
#
MODELLIB                  := ts_pendulimlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ts_pendulim_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/Pendulum_demo/ts_pendulim_sldrt_win64;E:/Pendulum_demo;E:/MATLAB_WORK/TS_Pendulum;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
