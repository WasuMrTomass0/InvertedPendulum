...
#ifndef RTW_HEADER_pendulim_exp_demoDemo_h_
#define RTW_HEADER_pendulim_exp_demoDemo_h_
#include <string.h>
#include <stddef.h>
#include <math.h>
#ifndef pendulim_exp_demoDemo_COMMON_INCLUDES_
# define pendulim_exp_demoDemo_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* pendulim_exp_demoDemo_COMMON_INCLUDES_ */

#include "pendulim_exp_demoDemo_types.h"
...
#define pendulim_exp_demoDemo_rtModel  RT_MODEL_pendulim_exp_demoDemo_T
...
} XDis_pendulim_exp_demoDemo_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Integrator_Reset_ZCE;     /* '<S12>/Integrator' */
} PrevZCX_pendulim_exp_demoDemo_T;
...
#define rtB                            pendulim_exp_demoDemo_B
#define BlockIO                        B_pendulim_exp_demoDemo_T
#define rtX                            pendulim_exp_demoDemo_X
#define ContinuousStates               X_pendulim_exp_demoDemo_T
#define rtXdot                         pendulim_exp_demoDemo_XDot
#define StateDerivatives               XDot_pendulim_exp_demoDemo_T
#define tXdis                          pendulim_exp_demoDemo_XDis
#define StateDisabled                  XDis_pendulim_exp_demoDemo_T
#define rtP                            pendulim_exp_demoDemo_P
#define Parameters                     P_pendulim_exp_demoDemo_T
#define rtDWork                        pendulim_exp_demoDemo_DW
#define D_Work                         DW_pendulim_exp_demoDemo_T
#define rtPrevZCSigState               pendulim_exp_demoDemo_PrevZCX
#define PrevZCSigStates                PrevZCX_pendulim_exp_demoDemo_T

/* Parameters (auto storage) */
struct P_pendulim_exp_demoDemo_T_ {
...
struct tag_RTM_pendulim_exp_demoDemo_T {
  const char_T *path;
...
extern P_pendulim_exp_demoDemo_T pendulim_exp_demoDemo_P;

/* Block signals (auto storage) */
extern B_pendulim_exp_demoDemo_T pendulim_exp_demoDemo_B;

/* Continuous states (auto storage) */
extern X_pendulim_exp_demoDemo_T pendulim_exp_demoDemo_X;

/* Block states (auto storage) */
extern DW_pendulim_exp_demoDemo_T pendulim_exp_demoDemo_DW;

/* External data declarations for dependent source files */

/* Zero-crossing (trigger) state */
extern PrevZCX_pendulim_exp_demoDemo_T pendulim_exp_demoDemo_PrevZCX;

/* Model entry point functions */
extern void pendulim_exp_demoDemo_initialize(void);
extern void pendulim_exp_demoDemo_output(void);
extern void pendulim_exp_demoDemo_update(void);
extern void pendulim_exp_demoDemo_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern pendulim_exp_demoDemo_rtModel *pendulim_exp_demoDemo(void);
...
extern RT_MODEL_pendulim_exp_demoDemo_T *const pendulim_exp_demoDemo_M;
 ...
 *
 * '<Root>' : 'pendulim_exp_demoDemo'
 * '<S1>'   : 'pendulim_exp_demoDemo/Alfa Normalization'
 * '<S2>'   : 'pendulim_exp_demoDemo/Cart-Pendulum System'
 * '<S3>'   : 'pendulim_exp_demoDemo/Controller PID'
 * '<S4>'   : 'pendulim_exp_demoDemo/Controller Swing-up'
 * '<S5>'   : 'pendulim_exp_demoDemo/Penalty'
 * '<S6>'   : 'pendulim_exp_demoDemo/Ref.Cart.Pos.'
 * '<S7>'   : 'pendulim_exp_demoDemo/Sensors'
 * '<S8>'   : 'pendulim_exp_demoDemo/Controller PID/Coulomb & Viscous Friction'
 * '<S9>'   : 'pendulim_exp_demoDemo/Controller PID/PIDCart'
 * '<S10>'  : 'pendulim_exp_demoDemo/Controller PID/PIDPend'
 * '<S11>'  : 'pendulim_exp_demoDemo/Controller Swing-up/Coulomb & Viscous Friction'
 * '<S12>'  : 'pendulim_exp_demoDemo/Controller Swing-up/Linear controller1'
 * '<S13>'  : 'pendulim_exp_demoDemo/Controller Swing-up/Not to escape watchdog'
 * '<S14>'  : 'pendulim_exp_demoDemo/Controller Swing-up/Soft landing arbiter'
 * '<S15>'  : 'pendulim_exp_demoDemo/Controller Swing-up/Swinging controller'
 */
#endif                                 /* RTW_HEADER_pendulim_exp_demoDemo_h_ */
