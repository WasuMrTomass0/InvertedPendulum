...
MODEL                := pendulim_exp_demoDemo
MODULES              := pendulim_exp_demoDemo_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c 
MAKEFILE             := pendulim_exp_demoDemo.mk
MATLAB_ROOT          := C:/PROGRA~1/MATLAB/R2015A~1
MATLAB_BIN           := C:/PROGRA~1/MATLAB/R2015A~1/bin
S_FUNCTIONS          := P1_Encoder.c P1_PWM.c P1_ResetEncoder.c P1_LimitFlag.c P1_SetLimit.c P1_Switch.c P1_PWMPrescaler.c P1_ResetSwitchFlag.c P1_ThermFlag.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
TID01EQ              := 1
...
#
MODELLIB                  := pendulim_exp_demoDemolib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := pendulim_exp_demoDemo_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/LP_sroda_1415/Pendulum_demo/pendulim_exp_demoDemo_sldrt_win64;E:/LP_sroda_1415/Pendulum_demo;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
%.obj : $(MATLAB_ROOT)/toolbox/PENDULUM1/DevDriv/%.c $(MAKEFILE)
	$(call BUILDOBJ, $(CC))
...
%.obj : $(MATLAB_ROOT)/toolbox/PENDULUM1/DevDriv/%.cpp $(MAKEFILE)
	$(call BUILDOBJ, $(CPP))
