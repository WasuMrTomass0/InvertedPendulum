...
MODEL                := P1_ExpDemo
MODULES              := P1_ExpDemo_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c 
MAKEFILE             := P1_ExpDemo.mk
...
#
MODELLIB                  := P1_ExpDemolib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := P1_ExpDemo_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/Pendulum_demo/P1_ExpDemo_sldrt_win64;E:/Pendulum_demo;$(MATLAB_ROOT)/toolbox/PENDULUM1/Mdl;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
