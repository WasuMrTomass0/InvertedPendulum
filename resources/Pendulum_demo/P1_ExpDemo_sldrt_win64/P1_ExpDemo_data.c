...
P_P1_ExpDemo_T P1_ExpDemo_P = {
  0.0,                                 /* Mask Parameter: RefCartPos_Amplitude
                                        ...
                                        *   '<S6>/square'
                                        */
  -0.0,                                /* Mask Parameter: PIDPend_D
                                        * Referenced by: '<S10>/Kd1'
                                        */
  -0.05,                               /* Mask Parameter: PIDCart_D
  ...
  8.5,                                 /* Mask Parameter: Softlandingarbiter_k
                                        * Referenced by: '<S14>/Gain'
                                        */
  0.01,                                /* Mask Parameter: CoulombViscousFriction_offset
                                        * Referenced by: '<S11>/Gain1'
                                        */
  1.0,                                 /* Mask Parameter: AlfaNormalization_pos
                                        * Referenced by: '<S1>/pos'
                                        */
  0.3,                                 /* Mask Parameter: Swingingcontroller_umax
                                        * Referenced by: '<S15>/umax'
                                        */
  0.2,                                 /* Mask Parameter: Linearcontroller1_umax1
