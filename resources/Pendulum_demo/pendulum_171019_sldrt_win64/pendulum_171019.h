...
#ifndef RTW_HEADER_pendulum_171019_h_
#define RTW_HEADER_pendulum_171019_h_
#include <string.h>
#include <stddef.h>
#include <math.h>
#ifndef pendulum_171019_COMMON_INCLUDES_
# define pendulum_171019_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* pendulum_171019_COMMON_INCLUDES_ */

#include "pendulum_171019_types.h"
...
#define pendulum_171019_rtModel        RT_MODEL_pendulum_171019_T
...
typedef struct {
  ...
  real_T Sum;                          /* '<S2>/Sum' */
  real_T Cart_pos;                     /* '<S3>/Gain3' */
  real_T Cart_vel;                     /* '<S3>/Gain4' */
  real_T AngleScale;                   /* '<S2>/Angle Scale' */
  real_T PendPosOut;                   /* '<S1>/angle normalization' */
  real_T Pend_vel;                     /* '<S3>/Gain2' */
  real_T PWM[3];                       /* '<S2>/PWM' */
...
} DW_pendulum_171019_T;

/* Backward compatible GRT Identifiers */
#define rtB                            pendulum_171019_B
#define BlockIO                        B_pendulum_171019_T
#define rtP                            pendulum_171019_P
#define Parameters                     P_pendulum_171019_T
#define rtDWork                        pendulum_171019_DW
#define D_Work                         DW_pendulum_171019_T

/* Parameters (auto storage) */
struct P_pendulum_171019_T_ {
...
struct tag_RTM_pendulum_171019_T {
  const char_T *path;
...
extern P_pendulum_171019_T pendulum_171019_P;

/* Block signals (auto storage) */
extern B_pendulum_171019_T pendulum_171019_B;

/* Block states (auto storage) */
extern DW_pendulum_171019_T pendulum_171019_DW;

/* Model entry point functions */
extern void pendulum_171019_initialize(void);
extern void pendulum_171019_output(void);
extern void pendulum_171019_update(void);
extern void pendulum_171019_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern pendulum_171019_rtModel *pendulum_171019(void);
...
extern RT_MODEL_pendulum_171019_T *const pendulum_171019_M;
 ...
 *
 * '<Root>' : 'pendulum_171019'
 * '<S1>'   : 'pendulum_171019/Alfa Normalization'
 * '<S2>'   : 'pendulum_171019/Cart-Pendulum System'
 * '<S3>'   : 'pendulum_171019/Sensors'
 */
#endif                                 /* RTW_HEADER_pendulum_171019_h_ */
